...
def get_ade20k_categories_with_prompt_eng():
    ...
    ade20k_id_names = open('./utils/ade20k_150_with_prompt_eng.txt').read().splitlines()
    ade_idx = 0
...
def get_cityscapes_categories_with_prompt_eng():
    ...
    cityscapes_id_names = open('./utils/cityscapes_with_prompt_eng.txt').read().splitlines()
    cityscapes_idx = 0
